...
repeat task.wait() until game.Players.LocalPlayer
	...
	for i,v in pairs(neededFunctions) do	
		...
		local TempData = {
			...
			["SelectedStands"] = {},
			["Sell"] = {},
			["AllItems"] = {"Mysterious Arrow", "Pure Rokakaka", "Rokakaka", "Diamond", "Lucky Arrow", "Dio's Diary", "Steel Ball", "Rib Cage of The Saint's Corpse", "Stone Mask", "Gold Coin", "Quinton's Glove", "Ancient Scroll", "Zepellin's Headband", "Lucky Stone Mask", "Green Candy", "Yellow Candy", "Red Candy", "Blue Candy"},
